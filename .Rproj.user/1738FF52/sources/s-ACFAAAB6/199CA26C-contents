...
My interdisciplinary quantitative research is organized around two central tenets of sociology: context and explanation. Contemporary contexts and outcomes are the function of cumulative, historical exposures. I use relational sociology to inform quantitative analyses of place, race, and class, focusing on the entangled, reciprocal systems of social and economic reproduction. My dissertation work uses causal mediation analysis to answer relational questions about the role of place in producing racialized inequality across the life-course, including the long-run consequences of racist housing policies on outcomes related to household wealth and individual health. My research is driven by a commitment to applying theory-driven quantitative methods to real-world problems in a way that is transparent, reproducible, and motivated by a need to address the fundamental causes of social and health inequity in the United States. 
...
{{< icon name="download" pack="fas" >}} Download my {{< staticref "media/Graetz_CV_January2022.pdf" "newtab" >}}CV{{< /staticref >}}.
